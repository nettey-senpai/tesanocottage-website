...
import { galleryfb } from "../constants";
...
const GalleryFBSection = () => {
  ...
  const prevSlide = () => {
    slideNumber === 0
      ? setSlideNumber(galleryfb.length - 1)
      : setSlideNumber(slideNumber - 1);
  };

  // function for next image
  const nextSlide = () => {
    slideNumber + 1 === galleryfb.length
      ? setSlideNumber(0)
      : setSlideNumber(slideNumber + 1);
  };
...
export default GalleryFBSection;
